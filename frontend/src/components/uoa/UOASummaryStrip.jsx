...
export default function UOASummaryStrip({ summary, spot }) {
  ...
  return (
    <div className="shrink-0 border-b border-[var(--border)] bg-[var(--surface-2)] px-4 py-2 font-mono text-[11px] flex flex-wrap items-center gap-x-4 gap-y-1">
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-green-400">Bull {fmtPremium(bullish_premium)}</span>
        ...
        <span className="text-red-400">Bear {fmtPremium(bearish_premium)}</span>
      </div>

      <span className="text-[var(--text-3)]">·</span>
      <span className="text-[var(--text-2)]">Net <span className={net_directional_premium >= 0 ? "text-green-400" : "text-red-400"}>{net_directional_premium >= 0 ? "+" : ""}{fmtPremium(net_directional_premium)}</span></span>
      <span className="text-[var(--text-3)]">·</span>
